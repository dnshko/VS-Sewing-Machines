...
{
    global $con;
    $sql="UPDATE `vs_user` SET `customer_name`='".mysqli_real_escape_string($con,$_POST['txtCustomerName'])."',`customer_number`='".mysqli_real_escape_string($con,$_POST['txtCustomerPhone'])."',`billing_address`='".mysqli_real_escape_string($con,$_POST['txtCustomerBilling'])."',`shipping_address`='".mysqli_real_escape_string($con,$_POST['txtCustomerShipping'])."' WHERE `customer_id`='".mysqli_real_escape_string($con,$_POST['txtCustomerID'])."'";    
...
{
    global $con;
    $sql="UPDATE `vs_user` SET `password`='".mysqli_real_escape_string($con,md5($_POST['txtPassword']))."' WHERE `customer_id`='".mysqli_real_escape_string($con,$_POST['txtCustomerID'])."'";
    if($result=$con->query($sql))
    {
