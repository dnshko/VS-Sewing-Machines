...
{
	$order_id=str_replace("#ORDvs","",base64_decode($_GET['oderid']));
	global $con;
	$sql="SELECT * FROM `vs_order` WHERE `order_id`='".$order_id."'";
	...
	<form method="post" name="customerData" action="ccavRequestHandler.php">
		<table width="40%" height="100" border='0' align="center"><caption><font size="4" color="blue"></font></caption></table>
			<table width="40%" height="100" border='0' align="center">
				...
				<tr>
					<td><input type="hidden" name="order_id" value="<?php echo "#ORDvs".$var['order_id']; ?>"/></td>
				</tr>
				<tr>
				...
				<tr>
					<td><input type="hidden" name="redirect_url" value="http://ashweembroiderysolution.com/ccavResponseHandler.php"/></td>
				</tr>
			 	<tr>
			 		<td><input type="hidden" name="cancel_url" value="http:/ashweembroiderysolution.com/ccavResponseHandler.php"/></td>
			 	</tr>
			 	<tr>
