...
$sql="SELECT * FROM `vs_cart` WHERE `User_ID`='".mysqli_real_escape_string($con,$rand)."' AND `product_id`='".mysqli_real_escape_string($con,$Product_ID)."'";
...
$sqlcommand="INSERT INTO `vs_cart`(`User_ID`, `product_id`, `product_price`, `qty`) VALUES ('".mysqli_real_escape_string($con,$rand)."','".mysqli_real_escape_string($con,$Product_ID)."','".mysqli_real_escape_string($con,$Amount)."','".mysqli_real_escape_string($con,"1")."')";
